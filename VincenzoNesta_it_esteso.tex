...
%\href{http://twitter.com/vinnes}{\twitter}~\href{http://twitter.com/vinnes}{@vinnes}
%\linkedin~\httplink{www.linkedin.com/in/vinnes}\\%
%\octocat~\httplink{www.github.com/vinnes}\\}
}
%citazione
%\myquote{\ldots l'aggetto delle cornici sbalzer\`a di la dal piombo le gocce, e con questo riguardo si verranno a mantenere salde le muraglie di mattoni}{M. Vitruvio Pollione - \itshape De Architectura}
...
\begin{tightitemize}
 \item Collaborazione al progetto europeo SERPENTE (Surpassing Energy Targets through Efficient Public
Buildings);
 ...
 \item Supporto all'Audit energetico nell'esecuzione dei controlli di qualit\`a per alcuni edifici in fase di certificazione CasaClima;
...
\tlcventry{2005}{2011}{Responsabile della Contabilit\`a}{Consorzio Etruria}{Montelupo F.no (FI)}{}{Contabilit\`a attiva e passiva di importanti Centri Commerciali realizzati in Toscana per UNICOOP Firenze:%
\begin{tightitemize}
...
\tlcventry{2002}{2005}{Direttore Tecnico}{Consorzio Etruria - Direzione Fuori Sede Puglia}{Lecce}{}{Gestione globale delle Commesse:
\begin{tightitemize}
...
%non lo metto perchè c'è già nella sezione ''Certificazioni''
...
\opening{Egregio signore,} % Opening greeting
\closing{Cordiali saluti,} % Closing phrase
\enclosure[Allegati]{curriculum vit\ae{}} % List of enclosed documents
