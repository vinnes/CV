...
\begin{tightitemize}
 \item Sviluppo di un'applicazione web-based (\href{https://github.com/vinnes/openstudio_nodejs}{Retrofit Manager Tool}) per semplificare il retrofit energetico di edifici civili e industriali;
